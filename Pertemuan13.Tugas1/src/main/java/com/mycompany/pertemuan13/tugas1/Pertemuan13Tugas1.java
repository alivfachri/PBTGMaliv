...
public class Pertemuan13Tugas1 {
    ...
    public static void main(String[] args) {
        ...
        CalculatorSederhana kalkulator = new CalculatorSederhana();

        // Menampilkan hasil operasi
        System.out.println("Hasil Pertambahan : " + kalkulator.tambah(10, 20));
        System.out.println("Hasil Pertambahan (3 angka) : " + kalkulator.tambah(10, 20, 30));
        System.out.println("Hasil Pengurangan : " + kalkulator.pengurangan(20, 10));
        System.out.println("Hasil Perkalian : " + kalkulator.perkalian(20, 10));
        System.out.println("Hasil Pembagian : " + kalkulator.pembagian(20, 10));
    }
}
